...
- Работал с **ЕИС (zakupki.gov.ru)** и **ЕАСУЗ** — ключевыми системами госзакупок.
...
| Исследования         | Telegram-боты          | ЕИС (zakupki.gov.ru)         |
| Data storytelling    | Автоматизация ETL      | ЕАСУЗ                        |
